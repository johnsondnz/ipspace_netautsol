# Interim Changes
## Further Study into Auotmation
* Installed Ansible AWX.
* Modified AWX docker image to include junos-eznc.
* Playbook now uses junos_config instead of napalm.
* Simplifid playbook structure.
* Loaded playbook into Ansible AWX.
* Created workflow in Ansible AWX and tested.
